//Stoplight
//Snapino (Elenco 6SCU31) - Project 5: Stoplight
//Transcribed from the Snapino Instruction Manual, page 18.
//
//Snapino controls the three Snap Circuits LEDs (green, yellow, and red)
//and turns them on and off like a stoplight. The yellow light is only on
//for half as long, just like a normal stoplight.
